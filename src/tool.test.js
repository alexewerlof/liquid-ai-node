...
describe('parseParamShorthand()', () => {
    test('should parse a required parameter correctly', () => {
    ...
    test('should throw an error if paramShorthand is not a string', () => {
    ...
    test('should throw an error for invalid format (missing colon)', () => {
        const paramShorthand = 'displayName string*'
        assert.throws(
    ...
    test('should throw an error for invalid format (too many colons)', () => {
    ...
    test('should throw for empty type', () => {
